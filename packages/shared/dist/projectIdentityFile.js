...
export const isCanonicalUuid = (value) => typeof value === 'string' && CANONICAL_UUID.test(value);
...
export function parseIdentityFile(text) {
    ...
    if ('repositoryFingerprint' in record &&
    ...
    const repositoryFingerprint = fingerprint
        ? { algorithmVersion: 1, hash: fingerprint.hash }
        : undefined;
    return {
        kind: 'ok',
        identity: {
            ...
            ...(record.projectName === undefined ? {} : { projectName: record.projectName }),
...
//# sourceMappingURL=projectIdentityFile.js.map