...
export async function runPkce(options) {
    ...
    const handler = (request, response) => {
        ...
        response.end('<!doctype html><title>Mnemonik signed in</title><p>You can use the terminal again.</p>', () => settle(url));
    };
    ...
    try {
        ...
        options.print(`Open this URL to sign in: ${authorizeUrl}`);
